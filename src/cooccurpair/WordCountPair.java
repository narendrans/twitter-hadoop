...
public class WordCountPair {
	...
	private static final transient Logger LOG = LoggerFactory.getLogger(WordCountPair.class);
	...
	public static void main(String[] args) throws Exception {
		...
		job.setMapperClass(TokenizerMapperPair.class);
		job.setCombinerClass(DoubleFrequencyReducer.class);
		job.setReducerClass(DoubleFrequencyReducer.class);
		job.setNumReduceTasks(4);
		job.setPartitionerClass(PartitionerWordCountPair.class);
